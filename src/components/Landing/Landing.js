            ...
            <div className='landing--container'>
                ...
                >
                    ...
                    >
                        ...
                        <p style={{ color: theme.tertiary }}>{headerData.desciption_1}</p>
                        <p style={{ color: theme.tertiary }}>{headerData.desciption_2}</p>
                        <p style={{ color: theme.tertiary }}>{headerData.desciption_3}</p>
